...
#include "Camera.h"
#include "Model.h"
#include "Texture.h"//Nueva libreria 
...
int main()
{
	...
	//Se cargan los vertices y los indices 
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Draw skybox
		glDepthFunc(GL_LEQUAL); // se renderiza hasta el final 
		skyboxshader.Use();
		view = glm::mat4(glm::mat3(camera.GetViewMatrix())); // matriz de vista 
