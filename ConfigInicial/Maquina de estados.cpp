//SkyBox (adicional).	Suarez Velasco Gabriela
//Fecha de entrega : 09 de mayo de 2025		317313521
...
#include "Camera.h"
#include "Model.h"
#include "Texture.h" //SE ACABA DE AGREGAR PARA SKYBOX
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "SkyBox (adicional). Suarez Velasco Gabriela", nullptr, nullptr);
	...
	Shader skyboxshader("Shader/SkyBox.vs", "Shader/SkyBox.frag"); //SE AGREGA NUEVO SHADER SKYBOX
	...
	glEnableVertexAttribArray(0);
	glVertexAtribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(GLfloat), (GLvoid*)0);
	...
	faces.push_back("SkyBox/botton.jpg");
	faces.push_back("SkyBox/back.jpg");
	faces.push_back("SkyBox/front.jpg");

	GLuin cubemapTexture = TextureLoading::LoadCubemap(faces);
	...
	while (!glfwWindowShouldClose(window))
	{
	 ...
	 //   Ball.Draw(lightingShader); 
		...
		//DIBUJANDO LA CAJA SKYBOX
		glDepthFunc(GL_LEQUAL);
		skyboxshader.Use();
		view = glm::mat4(glm::mat3_cast(camera.GetViewMatrix()));
